...
let s:p.insert.left = [ [ s:black, s:bgreen ], [ s:black, s:green ] ]
let s:p.replace.left = [ [ s:bwhite, s:bred ], [ s:black, s:green ] ]
let s:p.visual.left = [ [ s:bwhite, s:yellow ], [ s:black, s:green ] ]
...
let g:lightline#colorscheme#gb16#palette = lightline#colorscheme#flatten(s:p)
